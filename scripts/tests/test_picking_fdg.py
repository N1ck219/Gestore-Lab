...
def run_test():
    ...
    materie = [
        ("741", "Kit IFP Synthera", "Kit IFP Synthera", "pz", "Kit IFP Synthera", "FDG", "", "NO", "NO", 0.0, 999, "Kit"),
        ("2065", "Kit chimico reagenti Synthera", "Kit chimico reagenti Synthera", "pz", "Kit chimico reagenti Synthera", "FDG", "", "NO", "NO", 0.0, 999, "Kit"),
        ("742", "Mannosio Triflato Synthera", "Mannosio Triflato Synthera", "pz", "Mannosio Triflato Synthera", "FDG", "", "NO", "NO", 0.0, 999, "Kit"),
        ("740", "Kit accessori Synthera", "Kit accessori Synthera", "pz", "Kit accessori Synthera", "FDG", "", "NO", "NO", 0.0, 999, "Kit"),
        ("461", "Kit di frazionamento", "Kit di frazionamento", "pz", "Kit di frazionamento", "FDG", "", "NO", "NO", 0.0, 999, "Kit"),
        ("1368", "Filtro Millex OR 0.22 micron", "Filtro Millex OR 0.22 micron", "pz", "Filtro Millex OR 0.22 micron", "FDG", "", "NO", "NO", 0.0, 999, "Filtri"),
        ("701", "Sodio cloruro 0,9% (250 ml)", "Sodio cloruro 0,9% (250 ml)", "pz", "Sodio cloruro 0,9% (250 ml)", "FDG", "", "NO", "NO", 0.0, 999, "Reagenti"),
        ("4379", "Flaconi sterili apirogeni crimpati HUAYI", "Flaconi sterili apirogeni crimpati HUAYI", "pz", "Flaconi sterili apirogeni crimpati HUAYI", "FDG", "", "NO", "NO", 0.0, 999, "Consumabili"),
        ("4380", "Capsule sterili HUAYI", "Capsule sterili HUAYI", "pz", "Capsule sterili HUAYI", "FDG", "", "NO", "NO", 0.0, 999, "Consumabili"),
        ("605", "Piastre TSA 55 mm", "Piastre TSA 55 mm", "pz", "Piastre TSA 55 mm", "FDG", "", "NO", "NO", 0.0, 999, "Consumabili"),
        ("606", "Piastre TSA 90 mm", "Piastre TSA 90 mm", "pz", "Piastre TSA 90 mm", "FDG", "", "NO", "NO", 0.0, 999, "Consumabili"),
        ("521", "Sodio Cloruro 10%", "Sodio Cloruro 10%", "pz", "Sodio Cloruro 10%", "FDG", "", "NO", "NO", 0.0, 999, "Reagenti"),
        ("3600", "Kit aggiuntivo di frazionamento", "Kit aggiuntivo di frazionamento", "pz", "Kit aggiuntivo di frazionamento", "FDG", "", "NO", "NO", 0.0, 999, "Kit"),
        ("4357", "Etanolo eccipiente", "Etanolo eccipiente", "pz", "Etanolo eccipiente", "FDG", "", "NO", "NO", 0.0, 999, "Reagenti"),
        ("424", "Acqua arricchita [18O]H2O", "Acqua arricchita [18O]H2O", "g", "Acqua arricchita [18O]H2O", "FDG", "", "NO", "NO", 0.0, 999, "Reagenti")
    ]
    cursor.executemany("""
    ...
    print("--- [TEST SUCCESSO: Picking FDG] ---")
    conn.close()
