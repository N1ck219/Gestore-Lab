...
def run_test():
    ...
    materie = [
        ("741", "Kit IFP Synthera", "Kit IFP Synthera", "pz", "Kit IFP Synthera", "FBB", "", "NO", "NO", 0.0, 999, "Kit"),
        ("2730", "Kit purificazione FBB", "Kit purificazione FBB", "pz", "Kit purificazione FBB", "FBB", "", "NO", "NO", 0.0, 999, "Kit"),
        ("2731", "Kit reagenti FBB", "Kit reagenti FBB", "pz", "Kit reagenti FBB", "FBB", "", "NO", "NO", 0.0, 999, "Kit"),
        ("2812", "Kit reagenti FBB (2-8°C)", "Kit reagenti FBB (2-8°C)", "pz", "Kit reagenti FBB (2-8°C)", "FBB", "", "NO", "NO", 0.0, 999, "Kit"),
        ("461", "Kit di frazionamento", "Kit di frazionamento", "pz", "Kit di frazionamento", "FBB", "", "NO", "NO", 0.0, 999, "Kit"),
        ("4636", "Filtro Minisart 0,22 micron", "Filtro Minisart 0,22 micron", "pz", "Filtro Minisart 0,22 micron", "FBB", "", "NO", "NO", 0.0, 999, "Filtri"),
        ("4379", "Flaconi sterili apirogeni crimpati HUAYI", "Flaconi sterili apirogeni crimpati HUAYI", "pz", "Flaconi sterili apirogeni crimpati HUAYI", "FBB", "", "NO", "NO", 0.0, 999, "Consumabili"),
        ("4380", "Capsule sterili HUAYI", "Capsule sterili HUAYI", "pz", "Capsule sterili HUAYI", "FBB", "", "NO", "NO", 0.0, 999, "Consumabili"),
        ("605", "Piastre TSA 55 mm", "Piastre TSA 55 mm", "pz", "Piastre TSA 55 mm", "FBB", "", "NO", "NO", 0.0, 999, "Consumabili"),
        ("606", "Piastre TSA 90 mm", "Piastre TSA 90 mm", "pz", "Piastre TSA 90 mm", "FBB", "", "NO", "NO", 0.0, 999, "Consumabili"),
        ("424", "Acqua arricchita [18O]H2O", "Acqua arricchita [18O]H2O", "g", "Acqua arricchita [18O]H2O", "FBB", "", "NO", "NO", 0.0, 999, "Reagenti")
    ]
    cursor.executemany("""
    ...
    print("--- [TEST SUCCESSO: Picking FBB] ---")
    conn.close()
