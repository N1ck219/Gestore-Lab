...
def run_test():
    ...
    materie = [
        ("5653", "Fcholine Trasis cassette", "Fcholine Trasis cassette", "pz", "Fcholine Trasis cassette", "FCH", "", "NO", "NO", 0.0, 999, "Kit"),
        ("5652", "Fcholine Trasis Kit of reagents", "Fcholine Trasis Kit of reagents", "pz", "Fcholine Trasis Kit of reagents", "FCH", "", "NO", "NO", 0.0, 999, "Kit"),
        ("5651", "Fcholine Trasis KIT eluent QMA (2-8°C)", "Fcholine Trasis KIT eluent QMA (2-8°C)", "pz", "Fcholine Trasis KIT eluent QMA (2-8°C)", "FCH", "", "NO", "NO", 0.0, 999, "Kit"),
        ("5659", "Sodio Cloruro 0,9% Bag 250ml", "Sodio Cloruro 0,9% Bag 250ml", "pz", "Sodio Cloruro 0,9% Bag 250ml", "FCH", "", "NO", "NO", 0.0, 999, "Consumabili"),
        ("4487", "Acqua PPI Bag 250ml", "Acqua PPI Bag 250ml", "pz", "Acqua PPI Bag 250ml", "FCH", "", "NO", "NO", 0.0, 999, "Consumabili"),
        ("2691", "Filtro Millex GP", "Filtro Millex GP", "pz", "Filtro Millex GP", "FCH", "", "NO", "NO", 0.0, 999, "Filtri"),
        ("5584", "Filtro Pall", "Filtro Pall", "pz", "Filtro Pall", "FCH", "", "NO", "NO", 0.0, 999, "Filtri"),
        ("461", "Kit di frazionamento", "Kit di frazionamento", "pz", "Kit di frazionamento", "FCH", "", "NO", "NO", 0.0, 999, "Kit"),
        ("701", "Sodio cloruro 0,9% (250 ml)", "Sodio cloruro 0,9% (250 ml)", "pz", "Sodio cloruro 0,9% (250 ml)", "FCH", "", "NO", "NO", 0.0, 999, "Reagenti"),
        ("4379", "Flaconi sterili apirogeni crimpati HUAYI", "Flaconi sterili apirogeni crimpati HUAYI", "pz", "Flaconi sterili apirogeni crimpati HUAYI", "FCH", "", "NO", "NO", 0.0, 999, "Consumabili"),
        ("4380", "Capsule sterili HUAYI", "Capsule sterili HUAYI", "pz", "Capsule sterili HUAYI", "FCH", "", "NO", "NO", 0.0, 999, "Consumabili"),
        ("605", "Piastre TSA 55 mm", "Piastre TSA 55 mm", "pz", "Piastre TSA 55 mm", "FCH", "", "NO", "NO", 0.0, 999, "Consumabili"),
        ("606", "Piastre TSA 90 mm", "Piastre TSA 90 mm", "pz", "Piastre TSA 90 mm", "FCH", "", "NO", "NO", 0.0, 999, "Consumabili"),
        ("424", "Acqua arricchita [18O]H2O", "Acqua arricchita [18O]H2O", "g", "Acqua arricchita [18O]H2O", "FCH", "", "NO", "NO", 0.0, 999, "Reagenti")
    ]
    cursor.executemany("""
    ...
    print("--- [TEST SUCCESSO: Picking FCH] ---")
    conn.close()
